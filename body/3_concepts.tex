...
while approximately preserving the clustering objective." \autocite[1]{Chierichetti2018} This concept is essential for understanding fairness constraints in the \nameref{k-center} and \nameref{k-means} algorithms, which will cause us to address this topic in detail.
...
In summary, \textcite[4]{Chierichetti2018} state that "balance encapsulates a specific notion of fairness, where a clustering with a monochromatic cluster (i.e., fully unbalanced) is considered unfair. So we call the clustering [...] a $(b, r)$\textit{-fairlet decomposition} [...] and call each cluster [...] \textit{a fairlet}." \autocite[4]{Chierichetti2018}


\subsection{Stochastic Block Models}

The Stochastic Block Model concerns us only in \nameref{spectral-clustering}, of which \textcite{Kleindessner2019} have created a special variant. It is basically a generative model for random graphs and was originally introduced and defined by \textcite[]{Holland1983}:
